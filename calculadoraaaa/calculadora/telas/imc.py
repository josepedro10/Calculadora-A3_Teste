# -*- coding: utf-8 -*-
"""
Tela de Calculadora de IMC da Aplicação Figma.
Contém: Inputs para Peso (kg) e Altura (m), botão de cálculo e display estilizado de resultado com IMC e status correspondente.
"""
import tkinter as tk
from tkinter import messagebox
from calculadora.componentes.theme import ThemeConfig
from calculadora.utils.calculations import calcular_imc_status
