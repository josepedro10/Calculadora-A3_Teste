...
class TelaHome(tk.Frame):
    ...
    def config_tela(self):
        ...
        borda_frame = tk.Frame(self, bg="#000000", padx=3, pady=3)
        borda_frame.place(relx=0.5, rely=0.5, anchor="center", width=card_largura, height=card_altura)

        card_conteudo = tk.Frame(borda_frame, bg=cores["bg_card"])
        card_conteudo.pack(fill="both", expand=True)

        canvas_titulo = tk.Canvas(card_conteudo, bg=cores["bg_card"], highlightthickness=0, height=120)
